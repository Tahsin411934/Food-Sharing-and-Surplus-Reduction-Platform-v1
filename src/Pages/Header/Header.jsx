...
{/* upper navbar */}
      ...
      <div className="">
        <Navbar fluid rounded>
          <Navbar.Brand href="#">
            <img src="https://i.ibb.co/9GGYRxL/download.png" className="w-10 mr-3 h-10 sm:h-9" alt="PlateswapLogo" />
            <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">PlateSwap</span>
          </Navbar.Brand>
